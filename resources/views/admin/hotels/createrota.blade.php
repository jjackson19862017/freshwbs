...
@section('content')
                    ...
                    <div class="card-body">
                        <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <label for="mondayStartOne" class="col-form-label col-sm-3">Monday Start One</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="mondayRoleOne" class="col-form-label col-sm-3">Role</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="mondayStartTwo" class="col-form-label col-sm-3">Monday Start Two</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="mondayRoleTwo" class="col-form-label col-sm-3">Role</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="tuesdayStartOne" class="col-form-label col-sm-3">Tuesday Start One</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="tuesdayRoleOne" class="col-form-label col-sm-3">Role</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="tuesdayStartTwo" class="col-form-label col-sm-3">Tuesday Start Two</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="tuesdayRoleTwo" class="col-form-label col-sm-3">Role</label>
                                    <div class="col-sm-9">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <label for="mondayFinishOne" class="col-form-label col-sm-3">Monday Finish One</label>
                                    <div class="col-sm-9">
                            ...
                            <input type="number" id="mondayHoursOne" disabled="disabled" class="form-control text-right">
                            <div class="form-group row">
                                <label for="mondayFinishTwo" class="col-form-label col-sm-3">Monday Finish Two</label>
                                <div class="col-sm-9">
                            ...
                            <input type="number" id="mondayHoursTwo" disabled="disabled" class="form-control text-right">
                            <div class="form-group row">
                                <label for="tuesdayFinishOne" class="col-form-label col-sm-3">Tuesday Finish One</label>
                                <div class="col-sm-9">
                            ...
                            <div>
                            <input type="number" id="tuesdayHoursOne" disabled="disabled" class="form-control text-right">
                        </div>
                            <div class="form-group row">
                                <label for="tuesdayFinishTwo" class="col-form-label col-sm-3">Tuesday Finish Two</label>
                                <div class="col-sm-9">
                            ...
                            <div>
                            <input type="number" id="tuesdayHoursTwo" disabled="disabled" class="form-control text-right">
</div>
    ...
    <hr>
    <div class="form-group row">
        <label for="wednesdayStartOne" class="col-form-label col-sm-3">Wednesday Start One</label>
        <div class="col-sm-9">
    ...
    <div class="form-group row">
        <label for="wednesdayFinishOne" class="col-form-label col-sm-3">Wednesday Finish One</label>
        <div class="col-sm-9">
    ...
    <input type="number" id="wednesdayHoursOne" disabled="disabled" class="form-control text-right">
    <div class="form-group row">
        <label for="wednesdayRoleOne" class="col-form-label col-sm-3">Role</label>
        <div class="col-sm-9">
    ...
    <div class="form-group row">
        <label for="wednesdayStartTwo" class="col-form-label col-sm-3">Wednesday Start Two</label>
        <div class="col-sm-9">
    ...
    <div class="form-group row">
        <label for="wednesdayFinishTwo" class="col-form-label col-sm-3">Wednesday Finish Two</label>
        <div class="col-sm-9">
    ...
    <input type="number" id="wednesdayHoursTwo" disabled="disabled" class="form-control text-right">
    <div class="form-group row">
        <label for="wednesdayRoleTwo" class="col-form-label col-sm-3">Role</label>
        <div class="col-sm-9">
...
<hr>
<div class="form-group row">
    <label for="thursdayStartOne" class="col-form-label col-sm-3">Thursday Start One</label>
    <div class="col-sm-9">
...
<div class="form-group row">
    <label for="thursdayFinishOne" class="col-form-label col-sm-3">Thursday Finish One</label>
    <div class="col-sm-9">
...
<input type="number" id="thursdayHoursOne" disabled="disabled" class="form-control text-right">
<div class="form-group row">
    <label for="thursdayRoleOne" class="col-form-label col-sm-3">Role</label>
    <div class="col-sm-9">
...
<div class="form-group row">
    <label for="thursdayStartTwo" class="col-form-label col-sm-3">Thursday Start Two</label>
    <div class="col-sm-9">
...
<div class="form-group row">
    <label for="thursdayFinishTwo" class="col-form-label col-sm-3">Thursday Finish Two</label>
    <div class="col-sm-9">
...
<input type="number" id="thursdayHoursTwo" disabled="disabled" class="form-control text-right">
<div class="form-group row">
    <label for="thursdayRoleTwo" class="col-form-label col-sm-3">Role</label>
    <div class="col-sm-9">
...
<hr>
<div class="form-group row">
    <label for="fridayStartOne" class="col-form-label col-sm-3">Friday Start One</label>
    <div class="col-sm-9">
...
<div class="form-group row">
    <label for="fridayFinishOne" class="col-form-label col-sm-3">Friday Finish One</label>
    <div class="col-sm-9">
...
<input type="number" id="fridayHoursOne" disabled="disabled" class="form-control text-right">
<div class="form-group row">
    <label for="fridayRoleOne" class="col-form-label col-sm-3">Role</label>
    <div class="col-sm-9">
...
<div class="form-group row">
    <label for="fridayStartTwo" class="col-form-label col-sm-3">Friday Start Two</label>
    <div class="col-sm-9">
...
<div class="form-group row">
    <label for="fridayFinishTwo" class="col-form-label col-sm-3">Friday Finish Two</label>
    <div class="col-sm-9">
...
<input type="number" id="fridayHoursTwo" disabled="disabled" class="form-control text-right">
<div class="form-group row">
    <label for="fridayRoleTwo" class="col-form-label col-sm-3">Role</label>
    <div class="col-sm-9">
...
<hr>
<div class="form-group row">
    <label for="saturdayStartOne" class="col-form-label col-sm-3">Saturday Start One</label>
    <div class="col-sm-9">
...
<div class="form-group row">
    <label for="saturdayFinishOne" class="col-form-label col-sm-3">Saturday Finish One</label>
    <div class="col-sm-9">
...
<input type="number" id="saturdayHoursOne" disabled="disabled" class="form-control text-right">
<div class="form-group row">
    <label for="saturdayRoleOne" class="col-form-label col-sm-3">Role</label>
    <div class="col-sm-9">
...
<div class="form-group row">
    <label for="saturdayStartTwo" class="col-form-label col-sm-3">Saturday Start Two</label>
    <div class="col-sm-9">
...
<div class="form-group row">
    <label for="saturdayFinishTwo" class="col-form-label col-sm-3">Saturday Finish Two</label>
    <div class="col-sm-9">
...
<input type="number" id="saturdayHoursTwo" disabled="disabled" class="form-control text-right">
<div class="form-group row">
    <label for="saturdayRoleTwo" class="col-form-label col-sm-3">Role</label>
    <div class="col-sm-9">
...
<hr>
<div class="form-group row">
    <label for="sundayStartOne" class="col-form-label col-sm-3">Sunday Start One</label>
    <div class="col-sm-9">
...
<div class="form-group row">
    <label for="sundayFinishOne" class="col-form-label col-sm-3">Sunday Finish One</label>
    <div class="col-sm-9">
...
<input type="number" id="sundayHoursOne" disabled="disabled" class="form-control text-right">
<div class="form-group row">
    <label for="sundayRoleOne" class="col-form-label col-sm-3">Role</label>
    <div class="col-sm-9">
...
<div class="form-group row">
    <label for="sundayStartTwo" class="col-form-label col-sm-3">Sunday Start Two</label>
    <div class="col-sm-9">
...
<div class="form-group row">
    <label for="sundayFinishTwo" class="col-form-label col-sm-3">Sunday Finish Two</label>
    <div class="col-sm-9">
...
<input type="number" id="sundayHoursTwo" disabled="disabled" class="form-control text-right">
<div class="form-group row">
    <label for="sundayRoleTwo" class="col-form-label col-sm-3">Role</label>
    <div class="col-sm-9">
